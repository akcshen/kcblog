---
title: 抓包破解wifi
date: 2023-11-16 15:02:41
permalink: /pages/93a22b/
categories:
  - 更多
  - 实用技巧
tags:
...
使用ctrl+c停止监听，系统会将监听到的数据cap文件保存到本地/tmp文件夹下。打开cap文件，查看cap文件中的数据是否被抓取到，输入命令查看：
```
...
[MAC系统下破解WIFI密码（亲测可用，含wifi密码字典） - HZX↑ - 博客园](https://www.cnblogs.com/hzxll/p/16271446.html)

[GitHub - ZoraZora59/Get_Wifi_Password_On_MacOS: 在MacOS上，利用Aircrack-ng等工具获取附近可见wifi的明文密码](https://github.com/ZoraZora59/Get_Wifi_Password_On_MacOS)

[WPA/WPA2 密码字典，用于 wifi 密码暴力破解](https://github.com/conwnet/wpa-dictionary)